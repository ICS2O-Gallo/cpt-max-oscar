...
The player's goal is to reach the engine room to fix and engine and prevent the spaceship from failing.
...
Time the urgent, and the player needs to start as quickly as possible !!
